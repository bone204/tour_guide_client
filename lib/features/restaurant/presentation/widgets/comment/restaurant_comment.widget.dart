...
class _RestaurantCommentWidgetState extends State<RestaurantCommentWidget> {
  ...
  Widget _buildInputSection() {
    return BlocBuilder<RestaurantCommentCubit, RestaurantCommentState>(
      builder: (context, state) {
        final isSubmitting =
            state is RestaurantCommentLoaded && state.isSubmitting;
  ...
  Widget _buildRatingSelector(bool isSubmitting) => Row(
