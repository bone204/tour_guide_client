...
class CarBillPage extends StatefulWidget {
  const CarBillPage({super.key});

  @override
  State<CarBillPage> createState() => _CarBillPageState();
}

class _CarBillPageState extends State<CarBillPage> {
  String? selectedBank;
  ...
  Widget build(BuildContext context) {
    ...
    final totalAmount = 1_200_000.0;
    final totalAfterPoint =
        (totalAmount - travelPointToUse).clamp(0, totalAmount);

    return Scaffold(
      appBar: CustomAppBar(
        title: AppLocalizations.of(context)?.rentalInfo ?? 'Thông tin thuê xe',
        showBackButton: true,
              ...
              child: Column(
                ...
                children: [
                  ...
                  BillInfo(
                      ...
                      value: Formatter.currency(400000)),
                  SizedBox(height: 8.h),
                  Divider(height: 2.h, color: AppColors.primaryGrey),
