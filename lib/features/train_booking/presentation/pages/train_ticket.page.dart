    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 12.h),
          _buildNoteItem('Vui lòng có mặt tại ga trước 30 phút'),
          SizedBox(height: 8.h),
          _buildNoteItem('Mang theo CMND/CCCD khi lên tàu'),
          SizedBox(height: 8.h),
          _buildNoteItem('Xuất trình mã QR và giấy tờ tùy thân để xác nhận'),
          SizedBox(height: 8.h),
          _buildNoteItem('Hành lý mang theo tối đa 30kg'),
        ],
      ),
    );
  }
