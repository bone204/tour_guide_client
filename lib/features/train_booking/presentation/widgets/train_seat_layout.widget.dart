...
class _TrainSeatLayoutWidgetState extends State<TrainSeatLayoutWidget> {
  ...
  void _initializeSeatStatuses() {
    ...
    for (int coach = 1; coach <= 8; coach++) {
      ...
      final bookedIndices =
          [3, 7, 12, 15, 20, 25, 28].where((i) => i < totalSeats).toList();
      ...
      if (alreadySelected) {
        ...
        CustomSnackbar.show(
          ...
          message: AppLocalizations.of(
            context,
          )!.maxSeatsSelectedTrain(widget.maxSeats),
        ...
        Container(
          ...
          child: Column(
            children: [
              ...
              // Seats
              isBerth ? _buildBerthLayout() : _buildSeatLayout(),
            ],
          ),
        ),
      ...
      children: [
        ...
        Container(
          ...
          child: Text(
            ...
            style: Theme.of(
              context,
            ).textTheme.displayMedium?.copyWith(color: AppColors.primaryWhite),
          ),
        ),
      ],
    );
  ...
  Widget _buildBerthLayout() {
    ...
    final compartments =
        (currentCoachSeats.length / berthsPerCompartment).ceil();
