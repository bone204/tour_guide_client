...
class GetReformProvincesUseCase {
  Future<Either<Failure, List<ReformProvince>>> call(String? search) async {
    return sl<MappingAddressRepository>().getReformProvinces(search);
  }
}
