...
import 'package:tour_guide_app/features/hotel/presentation/widgets/comment/hotel_review_item.widget.dart';
...
class HotelCommentWidget extends StatefulWidget {
  final int hotelId;

  const HotelCommentWidget({super.key, required this.hotelId});

  @override
  State<HotelCommentWidget> createState() => _HotelCommentWidgetState();
}

class _HotelCommentWidgetState extends State<HotelCommentWidget> {
  final TextEditingController _commentController = TextEditingController();
  late HotelCommentCubit _cubit;
  ...
  void initState() {
    super.initState();
    _cubit = sl<HotelCommentCubit>()..loadComments(widget.hotelId);
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      ...
      child: BlocListener<HotelCommentCubit, HotelCommentState>(
        listener: (context, state) {
          ...
          } else if (state is HotelCommentError) {
  ...
  Widget _buildInputSection() {
    return BlocBuilder<HotelCommentCubit, HotelCommentState>(
      builder: (context, state) {
        final isSubmitting = state is HotelCommentLoaded && state.isSubmitting;
  ...
  Widget _buildCommentList() {
    return BlocBuilder<HotelCommentCubit, HotelCommentState>(
      builder: (context, state) {
        if (state is HotelCommentLoading) {
        ...
        } else if (state is HotelCommentLoaded) {
            ...
            children: [
              ListView.separated(
                ...
                itemBuilder: (context, index) {
                  return HotelReviewItem(feedback: state.comments[index]);
                },
              ),
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  TextButton(
                    onPressed: () => _cubit.loadComments(widget.hotelId),
