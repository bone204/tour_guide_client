...
class RentalBillListPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: const _RentalBillListView(),
    );
  }
}

class _RentalBillListView extends StatefulWidget {
  const _RentalBillListView();

  @override
  State<_RentalBillListView> createState() => _RentalBillListViewState();
}

class _RentalBillListViewState extends State<_RentalBillListView> {
  ...
  void initState() {
    super.initState();
    _subscription = eventBus.on<RentalBillUpdatedEvent>().listen((event) {
      if (mounted) {
        _onRefresh(context);
      }
    });
