...
class CooperationCard extends StatelessWidget {
            ...
            Stack(
              children: [
                ...
                ClipRRect(
                  ...
                  child: Stack(
                    children: [
                      cooperation.photo != null && cooperation.photo!.isNotEmpty
                          ? Image.network(
                            cooperation.photo!,
                ...
                Positioned(
                  ...
                  >(
                    builder: (context, state) {
                      final isLiked = state.favoriteIds.contains(
                        cooperation.id,
                      );
                      return Container(
                    ...
                    children: [
                      ...
                      if (cooperation.type != null) ...[
                        ...
                        Container(
                          ...
                          child: Text(
                            cooperation
                                .type!, // You might want to localize this if possible
                            style: Theme.of(context).textTheme.displayMedium
                                ?.copyWith(color: AppColors.textPrimary),
                          ),
                        ),
