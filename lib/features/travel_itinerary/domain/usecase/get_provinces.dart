...
class GetProvincesUseCase implements UseCase<Either<Failure, ProvinceResponse>, ProvinceQuery> {
  @override
  Future<Either<Failure, ProvinceResponse>> call(ProvinceQuery query) async {
    return await sl<ItineraryRepository>().getProvinces(query);
  }
}
