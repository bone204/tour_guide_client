...
class EditStopDetailsUseCase
    implements UseCase<Either<Failure, Stop>, EditStopDetailsParams> {
  final ItineraryRepository _repository = sl<ItineraryRepository>();

  @override
  Future<Either<Failure, Stop>> call(EditStopDetailsParams params) async {
    return await _repository.editStopDetails(
      params.itineraryId,
      params.stopId,
      params.request,
    );
...
class EditStopDetailsParams extends Equatable {
  final int itineraryId;
  final int stopId;
  final EditStopDetailsRequest request;

  const EditStopDetailsParams({
