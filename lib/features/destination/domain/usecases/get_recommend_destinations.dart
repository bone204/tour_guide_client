...
class GetRecommendDestinationsUseCase implements UseCase<Either<Failure, DestinationResponse>, DestinationQuery> {
  @override
  Future<Either<Failure, DestinationResponse>> call(DestinationQuery params) async {
    return await sl<DestinationRepository>().getRecommendDestinations(params);
  }
}
